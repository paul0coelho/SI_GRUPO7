 ...
 */
public class ReceberReferenciaPagamento {
    ...
    public static void main(String[] args) {
        ...
        try (final ZeebeClient client
            ...
            final JobWorker receberReferenciaPagamentoWorker
                    = client.newWorker()
                            .jobType("Referencia")  // Nome da mensagem
                            .handler(new ReceberReferenciaPagamentoHandler())  // Handler que irá processar a mensagem
                            .timeout(Duration.ofSeconds(10).toMillis())
                            .open();

            System.out.println("Worker configurado para receber a referência de pagamento. Aguardando mensagens...");
            Thread.sleep(10000);
        } catch (Exception e) {
            e.printStackTrace();
        }
